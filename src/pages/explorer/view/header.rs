...
pub fn render(
    ...
    let breadcrumb = render_breadcrumb(page, cx);
    ...
    div()
        ...
        .py(px(12.0))
        .gap_2()
        .child(render_nav_buttons(can_go_back, can_go_forward, cx))
        .child(
            div()
                .flex_1()
                .overflow_hidden()
                .min_w(px(0.0))
                .child(div().flex().items_center().child(breadcrumb)),
        )
        .child(render_right_actions(page, entry_count, search_visible, cx))
}
...
fn render_view_mode_toggle(
    ...
    div()
        ...
        .child(view_mode_button(
            page, ViewMode::List, "view-mode-list",
            IconName::PanelBottomOpen, "List", cx,
        ))
        .child(view_mode_button(
            page, ViewMode::Grid, "view-mode-grid",
            IconName::LayoutDashboard, "Grid", cx,
        ))
}
